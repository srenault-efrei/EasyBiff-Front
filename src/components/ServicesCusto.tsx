...
import { SafeAreaView, View, TextInput, Text, Picker, TouchableOpacity, AsyncStorage, FlatList, Image } from 'react-native';
            ...
            <SafeAreaView>
                ...
                <View style={styles.researchContainer}>
                    <TextInput
                        ...
                        style={styles.inputResearch} onChangeText={(text) => { this.searchMatchedServices(text) }}
                    />
